...
Caben 2 posibilidades: o tenemos una elipse, o el vacío (deduciéndolo de la tabla anterior).

Si $k<0$, por Cauchy-Schwarz: $|z| + <z,e> \ge |z| - |z||e| \ge 0$, y no habría solución real (realmente estamos ante una elipse en los complejos).

Si $k>=0$ veamos ahora que suponiendo $y=0$ y veamos que $\exists x$ tal que $(x,y)$ cumple la ecuación (luego no sería vacía):
